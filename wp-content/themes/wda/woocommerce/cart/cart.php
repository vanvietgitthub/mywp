							...
							<div class="product-remove">
								<?php
									...
									echo apply_filters( 'woocommerce_cart_item_remove_link', sprintf(
										'<a href="%s" class="remove" aria-label="%s" data-product_id="%s" data-product_sku="%s"><i class="fas fa-trash-alt" style="font-size: 12px;"></i> Xóa sản phẩm</a>',
